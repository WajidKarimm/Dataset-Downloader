#!/usr/bin/env python3
"""
Universal Dataset Downloader Tool
Downloads datasets in multiple formats (CSV, Excel, JSON, ARFF, XML, TSV, TXT)
with intelligent parsing and automatic organization to D drive
"""
...
class UniversalDatasetDownloader:
    def __init__(self, base_dir="D:/datasets"):
        """
        Initialize the universal dataset downloader
